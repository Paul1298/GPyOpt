...
class AcquisitionLP(AcquisitionBase):
    ...
    :param model: model of the class MyGPyOpt
    :param space: design space of the class MyGPyOpt.
    :param optimizer: optimizer of the class MyGPyOpt.
    :param acquisition: acquisition function of the class MyGPyOpt
