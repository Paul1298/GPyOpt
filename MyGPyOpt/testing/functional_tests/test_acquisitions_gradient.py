...
from MyGPyOpt.acquisitions import AcquisitionEI, AcquisitionMPI, AcquisitionLCB
...
class TestAcquisitionsGradients(unittest.TestCase):
    ...
    def setUp(self):
        ...
        objective = MyGPyOpt.objective_examples.experiments1d.forrester()
        self.feasible_region =  MyGPyOpt.Design_space(space = [{'name': 'var_1', 'type': 'continuous', 'domain': objective.bounds[0]}])
        n_inital_design = 10
