...
class TestBayesianOptimization(unittest.TestCase):
    def test_next_locations_pending(self):
        func = MyGPyOpt.objective_examples.experiments1d.forrester()
    ...
    def test_one_initial_data_point(self):
        ...
        model = MyGPyOpt.models.GPModel(max_iters=0)
    ...
    def test_infinite_distance_last_evaluations(self):
        ...
        bo = MyGPyOpt.methods.BayesianOptimization(lambda x: x * x, domain=domain,
                                                   X=None, Y=None,
        ...
        bo2 = MyGPyOpt.methods.BayesianOptimization(lambda x: x * x, domain=domain,
